        ...
        <section className="px-4 pt-8 pb-12 sm:px-6 sm:pt-10 sm:pb-16">
            <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2 lg:gap-12">
                <div className="max-w-2xl space-y-6 text-center">
                    ...
                    <p className="font-[family-name:var(--font-inter)] text-sm leading-7 text-gray-400 sm:text-base sm:leading-8">Criamos automações que organizam o atendimento, aceleram respostas e ajudam empresas a atenderem melhor, ganhar tempo e converter mais.</p>
